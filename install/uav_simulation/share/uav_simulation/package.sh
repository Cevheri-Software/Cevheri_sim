...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/home/ibz/uav_ws/install/uav_simulation"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/uav_simulation/hook/path.sh"
